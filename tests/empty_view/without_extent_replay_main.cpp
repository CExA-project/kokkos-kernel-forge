...
int main(int argc, char* argv[]) {
  ...
  int* in_data =
      static_cast<int*>(cexa::kernel_replayer::get_allocation<memory_space>(
          "empty_values_without_extent"));
  int* out_data =
      static_cast<int*>(cexa::kernel_replayer::get_out_allocation<memory_space>(
          "empty_values_without_extent"));
